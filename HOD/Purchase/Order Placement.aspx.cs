...
public partial class HOD_Purchase_Order_Placement : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Orderr")
        {
            ...
            while (dr1.Read())
            {
                ...
                lblDate1.Text = System.DateTime.Now.ToShortDateString();
            }
            /*
            SortedList sl = new SortedList();
    ...
    protected void btnOrderSubmit_Click(object sender, EventArgs e)
    {
        ...
        sl.Add("@Price", Label4.Text);
        sl.Add("@Description", txtDescription.Text);
        sl.Add("@Order_Date", Convert.ToDateTime(lblDate.Text));
    ...
    {
        //int n = Convert.ToInt32(lblUnitPrice.Text);
        //int m = Convert.ToInt32(txtQuantity.Text);
        //Label4.Text = (n * m).ToString();
    }
