<%@ Page Title="" Language="C#" MasterPageFile="~/HOD/Marketing/Marketing_HOD.master" AutoEventWireup="true" CodeFile="View Employee Detail.aspx.cs" Inherits="HOD_Account_View_Employee_Detail" %>
            ...
            <asp:TemplateField HeaderText="View Profile">
                <ItemTemplate>
                    <asp:LinkButton ID="LinkButton1" CommandName="Vieww" CausesValidation="false" 
                        CommandArgument='<%#Eval("Schemes_ID") %>' runat="server">View</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
