<%@ Page Title="" Language="C#" MasterPageFile="~/HR MasterPage.master" AutoEventWireup="true" CodeFile="HR_profile_update1.aspx.cs" Inherits="HR_profile_update1" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    Height="372px" Width="973px" ScrollBars="Both" VerticalStripWidth="150px">
    ...
    <asp:TabPanel ID="TabPanel2" runat="server" HeaderText="TabPanel2">
        ...
        <ContentTemplate>
            <table class="style26">
                ...
                <tr>
                    <td class="style30">
                        <asp:Button ID="btnNext0" runat="server" onclick="btnNext0_Click" Text="Next" />
                    </td>
                    <td>
    ...
    <asp:TabPanel ID="TabPanel3" runat="server" HeaderText="TabPanel3">
        ...
        <ContentTemplate>
            <table class="style26">
                ...
                <tr>
                    <td class="style28">
                        <asp:Button ID="btnNext1" runat="server" onclick="btnNext1_Click" Text="Next" />
                    </td>
                    <td colspan="2">
