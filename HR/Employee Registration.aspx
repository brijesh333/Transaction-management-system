<%@ Page Title="" Language="C#" MasterPageFile="~/HR/HR.master" AutoEventWireup="true" CodeFile="Employee Registration.aspx.cs" Inherits="HR_Employee_Registration" %>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator25" runat="server" 
                                                        ControlToValidate="txtPinCode" ErrorMessage="Must Enter PINCode" 
                                                        ForeColor="Red"></asp:RequiredFieldValidator>
                                                </td>
                                                <td>
                                                    &nbsp;</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator26" runat="server" 
                                                        ControlToValidate="txtContactNo" ErrorMessage="Must Enter Contact No" 
                                                        ForeColor="Red"></asp:RequiredFieldValidator>
                                                </td>
                                                <td>
                                                    &nbsp;</td>
                            ...
                            <table class="style1">
                                ...
                                <tr>
                                    ...
                                    <td class="style4">
                                        ...
                                        &nbsp;<span class="style13">(dd/mm/yyyy)<span class="style2">*</span></span></td>
                                    <td class="style4">
                                ...
                                <tr>
                                    ...
                                    <td class="style3">
                                        <asp:CompareValidator ID="CompareValidator1" runat="server" 
                                            ...
                                            ErrorMessage="Password Does Not Matched" ForeColor="Red"></asp:CompareValidator>
                                    </td>
                                    <td class="style3">
                                        &nbsp;</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="style3">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator24" runat="server" 
                                            ...
                                            ErrorMessage="Enter Proper Bank Account No" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </td>
                                    <td class="style3">
                                        &nbsp;</td>
                                </tr>
                            ...
                            <table class="style1">
                                ...
                                <tr>
                                    ...
                                    <td class="style29">
                                        ...
                                        &nbsp;<span class="style2"> (.pdf files)*</span></td>
                                    <td class="style28">
                                ...
                                <tr>
                                    ...
                                    <td class="style29">
                                        ...
                                        <span class="style13">&nbsp;<span class="style2">(.pdf files)*</span></span></td>
                                    <td class="style28">
                                ...
                                <tr>
                                    ...
                                    <td class="style29">
                                        ...
                                        &nbsp;<span class="style2">(.jpg,.gif format)*</span></td>
                                    <td class="style28">
