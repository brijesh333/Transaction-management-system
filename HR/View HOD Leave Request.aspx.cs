...
public partial class HR_Leave_Request_by_HOD : System.Web.UI.Page
{
    ...
    public void grid_bind()
    {
        ...
        sl.Add("@query", "Select HOD request");
        sl.Add("@Department_ID", Session["Department_ID"]);
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Approve")
        {
            ...
            while (dr.Read())
            {
                ...
                Session["LEmployee_ID"] = dr["Employee_ID"].ToString();
    ...
    public void amp_data_fatch()
    {
        ...
        sl.Add("@Employee_ID", Convert.ToInt32(Session["LEmployee_ID"].ToString()));
    ...
    {
        int id = Convert.ToInt32(Session["LEmployee_ID"].ToString());
       ...
       // leave_count();
        ...
        if (l_type == 7)
        {
            ...
            sl.Add("@Employee_ID", Session["LEmployee_ID"].ToString());
