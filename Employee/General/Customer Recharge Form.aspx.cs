...
public partial class Employee_General_Customer_Recharge_Form : System.Web.UI.Page
{
    ...
    protected void btnProceed_Click(object sender, EventArgs e)
    {
        ...
        sl.Add("@query", "demo");
        sl.Add("@Customer_ID", txtCustomerID.Text);
        SqlDataReader dr3 = ERP.GetDataReaderSP("cust_reg_sp", sl3);
        while (dr3.Read())
        {
            lblCustomerName.Text = dr3["Customer_Name"].ToString();
            lblCustomerAddress.Text = dr3["Address"].ToString();
            lblRegBranch.Text = dr3["Branch_Name"].ToString();
        ...
        */
        ...
        sl2.Add("@Customer_ID", txtCustomerID.Text);
        SqlDataReader dr2 = ERP.GetDataReaderSP("customer_bal_sp", sl2);
        ...
        else
        {
            ...
            lblNewBalance.Text = dt2.Rows[0]["Regular_Bal"].ToString();
        }
    }
    ...
    {
        int a_bal = Convert.ToInt32(lblAvailableBalance.Text);
        int r_amount=Convert.ToInt32(txtRechargeAmount.Text);
        int c = a_bal + r_amount;
        lblNewBalance.Text = c.ToString();
    }
