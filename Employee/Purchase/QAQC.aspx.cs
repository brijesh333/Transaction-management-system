...
public partial class Employee_Purchase_QAQC : System.Web.UI.Page
{
    ...
    protected void btnApprove_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            sl5.Add("@Oreder_Date", Convert.ToDateTime(lblOrderDate.Text));
        ...
        sl6.Add("@query","Count");
        sl6.Add("@Product_Main_ID", Convert.ToInt32(Session["Product_Main_ID"].ToString()));
        sl6.Add("@Product_Sub_ID", Convert.ToInt32(Session["Product_Sub_ID"].ToString()));
        sl6.Add("@Product_ID", Convert.ToInt32(Session["Product_ID"].ToString()));
        SqlDataReader dr8= ERP.GetDataReaderSP("stock_of_product_sp", sl6);
        DataTable dt = new DataTable();
        dt.Load(dr);
        if (dt.Rows.Count==0)
        {
            ...
            sl7.Add("@Product_Main_ID", Convert.ToInt32(Session["Product_Main_ID"].ToString()));
            sl7.Add("@Product_Sub_ID", Convert.ToInt32(Session["Product_Sub_ID"].ToString()));
            sl7.Add("@Product_ID", Convert.ToInt32(Session["Product_ID"].ToString()));
            sl7.Add("@Avail_Quantity",lblReceivedQuantity.Text);
            sl7.Add("@Unit_Sell_Price", txtSalePrice.Text);
        ...
        else
        {
            ...
            sl8.Add("@Product_Main_ID", Convert.ToInt32(Session["Product_Main_ID"].ToString()));
            sl8.Add("@Product_Sub_ID", Convert.ToInt32(Session["Product_Sub_ID"].ToString()));
