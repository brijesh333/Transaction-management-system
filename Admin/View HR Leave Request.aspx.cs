...
public partial class Admin_View_HR_Leave_Request : System.Web.UI.Page
{
    ...
    public void grid_bind()
    {
        ...
        sl.Add("@query", "Select HR request");
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            for (int k = 0; k < dt2.Rows.Count; k++)
            {
                ...
                else
                {
                    ...
                    {
                        string da = dt3.Rows[y]["Day1"].ToString();
                        //DateTime wl = Convert.ToDateTime(dt3.Rows[k]["Day1"].ToString());
                        if ((df.DayOfWeek.ToString()).Equals(da))
                        {
